  ...
  return (
    <div className='flex items-center justify-center gap-16 px-4'>
      <div className='text-indigo-300 w-2/3'>
        <h2 className='text-5xl mb-9 leading-normal text-amber-400' id='greeting'><p className='text-3xl'><p className='mb-4'>안녕하세요!</p>🟡 동그라미 개발자 , </p><span className='text-white'>장수연</span>입니다! </h2>
